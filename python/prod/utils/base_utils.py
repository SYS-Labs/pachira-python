...
class BaseUtils():
    ...
    def sanitise_string(self, s: str) -> str:
        """Remove null characters."""
        # https://stackoverflow.com/a/18762899/315168
        return s.replace("\x00", "\U0000FFFD")
    
    
    def is_localhost_port_listening(self, port: int, host="localhost") -> bool:
    ...
    def find_free_port(self, min_port: int = 20_000, max_port: int = 40_000, max_attempt: int = 20) -> int:
    ...
    def to_unix_timestamp(self, dt: datetime.datetime) -> float:
